...
## Objective
광고 수익과 사용자 행동 분석을 위한 도구와 실험 프레임워크를 구축한다. 이번 페이즈는 **광고 슬롯 구축**에 중점을 둔다.

## Tasks
1. 광고 슬롯을 구성하고 추적 태그를 검증한다.
...
## Success Metrics
- 핵심 이벤트 추적 정확도 98%
- 광고 슬롯 도입 후 CPM 향상 목표 대비 80% 이상

## Notes
- 관련 산출물과 회의록은 `docs/records/phase-161/` 경로에 보관한다.
