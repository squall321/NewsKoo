# Phase 127 - 콘텐츠 편집 및 검수 UX

## Objective
검수자가 자동 번역본을 빠르게 확인·수정·게시할 수 있는 워크스페이스를 설계한다. 이번 페이즈는 **배치 승인 설계**에 중점을 둔다.

## Tasks
1. 배치 승인 시나리오를 와이어프레임과 사용자 흐름으로 표현한다.
...
## Notes
- 관련 산출물과 회의록은 `docs/records/phase-127/` 경로에 보관한다.
