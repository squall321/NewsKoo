# Phase 122 - 콘텐츠 편집 및 검수 UX

## Objective
검수자가 자동 번역본을 빠르게 확인·수정·게시할 수 있는 워크스페이스를 설계한다. 이번 페이즈는 **검수 대시보드 설계**에 중점을 둔다.

## Tasks
1. 검수 대시보드 시나리오를 와이어프레임과 사용자 흐름으로 표현한다.
...
## Success Metrics
- 검수 단계별 클릭 수 20% 감소
- 검수 대시보드 과업 만족도 4/5 이상

## Notes
- 관련 산출물과 회의록은 `docs/records/phase-122/` 경로에 보관한다.
